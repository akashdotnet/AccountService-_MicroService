...
namespace AccountService.API.Migrations
{
    ...
    [Migration("20220221112603_AccountService_Create_Dealer_Organization_Customer_Expert_Tables")]
    partial class AccountService_Create_Dealer_Organization_Customer_Expert_Tables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountService.API.Models.Audits.AuditOrganizationLocationServiceableZipCode", b =>
                {
                    b.Property<int>("AuditId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ServiceableZipCode")
                        .HasColumnType("text");
                    ...
                    b.ToTable("Audit_OrganizationLocationServiceableZipCodes");
                });
            ...
            modelBuilder.Entity("AccountService.API.Models.OrganizationLocationServiceableZipCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("OrganizationLocationServiceableZipCodes");
                });
            ...
            modelBuilder.Entity("AccountService.API.Models.OrganizationLocationServiceableZipCode", b =>
                {
                    b.HasOne("AccountService.API.Models.OrganizationLocation", "OrganizationLocation")
                        .WithMany("OrganizationLocationServiceZipCodes")
            ...
            modelBuilder.Entity("AccountService.API.Models.OrganizationLocation", b =>
                {
                    b.Navigation("OrganizationLocationServiceZipCodes");
                });
